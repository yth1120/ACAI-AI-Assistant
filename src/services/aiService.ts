...
import { validateRequest } from './ai/utils/validation'
import { createAIProvider } from './ai/aiServiceFactory'
import { withRetry } from './ai/utils/errorHandler'
...
export interface BaseAIProvider {
  sendMessage(messages: Message[], settingsStore: SettingsStore, onChunk?: ((chunk: string) => void) | null): Promise<string>
  cancelRequest(): void
